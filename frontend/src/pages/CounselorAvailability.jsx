      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <PlusIcon style={{ height: "1rem", width: "1rem" }} /> Add Date
              Override
            </button>
          </div>
            ...
            >
              ...
              <div
                style={{
                  ...
                  width: window.innerWidth < 640 ? "100%" : "auto",
                  justifyContent:
                    window.innerWidth < 640 ? "space-between" : "flex-end",
                }}
              >
                <span
                  style={{
                ...
                >
                  <Trash2Icon style={{ height: "1.25rem", width: "1.25rem" }} />
                </button>
              </div>
            </div>
        ...
        >
          ...
          <p style={{ fontSize: "0.875rem", margin: 0, lineHeight: 1.5 }}>
            ...
            Existing appointments within these times will remain scheduled
            unless you manually cancel them.
          </p>
        </div>
      </motion.div>
    </motion.div>
